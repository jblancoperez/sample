package br.tlf.oss.repository;

import br.tlf.oss.SampleApp;
import br.tlf.oss.config.Constants;
import br.tlf.oss.config.audit.AuditEventConverter;
import br.tlf.oss.domain.PersistentAuditEvent;
...
import static br.tlf.oss.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
